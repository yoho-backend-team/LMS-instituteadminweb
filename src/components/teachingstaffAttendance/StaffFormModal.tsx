      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <form className="flex flex-col gap-4 mt-10 pb-10">
              {" "}
              ...
              <div className="flex flex-row justify-end mt-10 gap-5">
                <div className="bg-[#1BBFCA1A] w-[98px] text-[#1BBFCA] py-2 px-2 text-center rounded-md border-2 border-[#1BBFCA] hover:bg-[#1BBFCA] hover:text-white cursor-pointer">
                  Reset
                </div>
                <div
