  ...
  return (
    <div>
      ...
      <div>
        {activeIndex === 0 && (
          <span
            className="text-[18px] font-semibold mb-6 ml-5 text-[#3B3939]"
          ...
          <ul className="space-y-3">
            ...
            >
              <img
                src={icon2}
                alt="icon"
                className="w-4 h-4 font-semibold text-[#716F6F]"
              />
          ...
          <div className="relative h-[530px] flex-6 ml-6 mt-5 bg-white  rounded-lg shadow-[0_4px_10px_3px_rgba(0,0,0,0.10)] p-2">
            <div className="flex flex-col md:flex-row bg-white p-1 rounded-lg  max-w-5xl">
              <div className=" lg:w-1/2 mb-5 md:mb-0">
                <h2
                  className="mb-2 mt-8 text-[#000000] "
                  style={{ ...FONTS.heading_11 }}
                >
                  Change Password
                </h2>
                <p
                  className="text-[#716F6F]font-medium text-gray-700 mb-2 mt-6 font-semibold "
                ...
                <ul className="text-sm text-gray-600 space-y-2 ml-2 mt-6">
                  ...
                  <li
                    className="flex items-start gap-5 mt-10 mb-20"
                    style={{ ...FONTS.heading_07 }}
                  >
                    <span className="text-green-500">✓</span>
              ...
              <div
                className="w-full md:w-1/2 mt-8 space-y-8 ml-1 font-semibold"
                style={{ ...FONTS.heading_07 }}
              >
                ...
                <button
                  ...
                  className="w-full bg-cyan-500 hover:bg-cyan-600 text-white font-medium py-2 mt-20 rounded-lg"
                  style={{ ...FONTS.heading_09 }}
                >
                  Change Password
                </button>
