...
export const FeesTableRow: React.FC<FeesTableRowProps> = ({
	fee,
	onEdit,
	index,
}) => {
		...
		<>
			<tr ref={dropdownRef}>
				...
				<td className='px-4 py-3 flex items-center gap-3'>
					<div>
						<img
							src={GetImageUrl(fee?.student?.image) ?? undefined}
							alt={fee?.student?.full_name}
				...
				<td className='px-4 py-3'>
					{new Date(fee.payment_date).toLocaleString('en-GB', {
						day: '2-digit',
						month: 'short',
						year: 'numeric',
						hour: '2-digit',
