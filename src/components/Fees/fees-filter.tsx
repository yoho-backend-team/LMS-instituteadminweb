...
export const FeesFilter: React.FC<FeesFilterProps> = ({ searchQuery, onSearchChange }) => {
  return (
    <div className="bg-white rounded-xl shadow p-4 border-gray mb-6 space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
        <div className="col-span-1 w-full md:w-[33%]">
          <label htmlFor="search-status" className="block text-sm text-gray-700 mb-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label htmlFor="select-batch" className="block text-sm text-gray-700 mb-1">
              Batches
            </label>
          ...
          <div>
            ...
            <input id="start-date" type="date" className="w-full border border-gray-300 rounded-md px-3 py-2" />
          </div>
          <div>
            <label htmlFor="end-date" className="block text-sm text-gray-700 mb-1">
              End Date
            </label>
            <input id="end-date" type="date" className="w-full border border-gray-300 rounded-md px-3 py-2" />
          </div>
        </div>
      </div>
    </div>
