          ...
          <div className="flex items-center justify-between mt-6">
            <div className="flex items-center space-x-4">
              <Avatar className="h-16 w-16">
                <AvatarImage src="/placeholder.svg?height=64&width=64" alt="Kamal Einstein" />
              ...
              {/* Details Section */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="altContact" placeholder="Enter alternate contact" />
                  </div>
                </div>
                <div className="mt-4 space-y-2">
                  ...
                  <Textarea id="address" placeholder="Enter address" className="min-h-[80px]" />
                </div>
              </div>
              ...
              {/* Course Details Section */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="courseDuration" placeholder="Enter duration" />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <Textarea id="learningFormat" placeholder="Enter learning format details" className="min-h-[80px]" />
                </div>
              </div>
