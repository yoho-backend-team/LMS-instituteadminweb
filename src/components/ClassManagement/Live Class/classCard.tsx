		...
		<Card className='rounded-xl shadow-[0px_0px_12px_rgba(0,0,0,0.08)] w-[auto] bg-white'>
			<CardContent className='p-4 pb-3 relative'>
				<div className='flex justify-between items-start border-b border-gray-200 pb-2'>
					<div>
						<h4 className='' style={{ ...FONTS.heading_03 }}>
							{title}
						</h4>
					</div>
					<DropdownMenu>
				...
				<div>
					<p
						className=' mt-4'
						style={{ ...FONTS.heading_03, fontSize: '16px' }}
					>
						{subtitle}
					</p>
				</div>
				<div className='flex items-center justify-between mt-4'>
					<div
						...
						style={{ ...FONTS.heading_03, fontSize: '14px' }}
					>
						{startDate}
					</div>
				...
				<div className='flex justify-end mt-12'>
					<Select onValueChange={(value: any) => setStatus(value)}>
						...
						>
							{status ? (
								<div
									className='w-[111px] h-[40px] bg-[#1BBFCA]  border rounded-md flex items-center justify-center'
