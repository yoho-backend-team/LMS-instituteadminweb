      ...
      <DialogContent className="max-w-sm text-center p-0 space-y-2">
        {step === "statusConfirm" && (
          <>
            ...
            <p style={{ ...FONTS.heading_03}}>Are you sure you want to change the status?</p>
            <div className="flex justify-center gap-4">
              <Button className="bg-[#1bbfca] hover:bg-[#1bbfca]" onClick={handleStatusConfirm}>
                Yes, Status
              </Button>
              <Button variant="outline" onClick={handleCancel}  className="border border-[#1bbfca] !text-[#1bbfca] bg-[#1bbeca15] px-4 py-2 rounded-md hover:bg-blue-50">
                Cancel
              </Button>
            </div>
          </>
        ...
        {step === "deleteConfirm" && (
          <>
            ...
            <p style={{ ...FONTS.heading_03}}>Are you sure you want to delete this FAQ category?</p>
            <div className="flex justify-center gap-4 ">
