...
export default function StudentDashboardMain() {
  ...
  const filteredStudents =
    batchData?.student?.filter((student: any) =>
    ...
    <div className="p-6  min-h-screen">
      ...
      <div className="relative max-w-md mb-6">
        <input
          ...
          className="border border-[#1BBFCA] pl-10 p-2 rounded-md "
          style={{ ...FONTS.heading_11, color: COLORS.gray_dark_03 }}
        />
        <Search className="absolute left-3 top-7.5 -translate-y-1/2 h-4 w-4 text-[#1BBFCA]" />
      </div>
      <div className="space-y-4">
        {filteredStudents.length > 0 ? (
          ...
          <p
            ...
            style={{ ...FONTS.heading_09, color: COLORS.gray_dark_03 }}
          >
            No students found
          </p>
        )}
