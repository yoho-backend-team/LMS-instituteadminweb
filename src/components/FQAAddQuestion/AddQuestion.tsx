  ...
  return (
    <div className="px-4 py-6 sm:px-6 md:px-8 lg:px-12 xl:px-16">
      ...
      <div className="flex flex-wrap sm:flex-nowrap gap-4 mb-6">
        <input
          type="text"
          className="border-2 font-semibold border-[#1BBFCA] px-4 py-2 rounded-xl flex-grow min-w-[180px] sm:w-1/3"
          placeholder="Search Category"
          value={searchQuery}
          onChange={(e) => setSearchQuery(e.target.value)}
        />
        <button
          className="flex bg-teal-400 text-white text-lg px-4 py-2 rounded-lg ml-auto"
          onClick={() => {
            resetForm();
            setShowModal(true);
          }}
