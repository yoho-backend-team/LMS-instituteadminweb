	...
	return (
		<div className=" h-[86vh] p-4  overflow-y-scroll overflow-x-hidden scrollbar-hide" >
			...
			<div className=" mx-auto space-y-6">
				...
				<div className="flex justify-between items-center">
					<div className="relative">
						<input
							style={{ ...FONTS.heading_06, border: `2px solid ${COLORS.primary}` }}
							placeholder="Branch"
						...
						{periodOpen && (
							<div className="absolute top-full right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg z-10 p-4 w-64">
								<div className="space-y-4">
									{/* Month Selector */}
									<div>
										<label className="block text-sm font-medium text-[#716F6F] mb-1">Month</label>
										<div className="relative">
											<select
												title="Months"
									...
									{/* Year Selector */}
									<div>
										<label className="block text-sm font-medium text-[#716F6F] mb-1">Year</label>
										<div className="relative">
											<select
												title="Years"
												className="w-full p-2 border border-gray-300 rounded-md appearance-none pr-8 text-[#716F6F]"
									...
									<button
										...
										onClick={handleApply}
										style={{ background: COLORS.primary, ...FONTS.heading_07 }}
									>
										Apply
									</button>
								</div>
				...
				<section className=" w-[25%] flex flex-col gap-7">
					...
					<div className="bg-white shadow-[4px_4px_24px_0px_#0000001A] rounded-xl p-4 px-5 grid gap-5">
						<div className="flex items-center gap-6">
							...
							<div className="flex flex-col gap-2 ">
								<span className="text-[#716F6F]" style={{ ...FONTS.heading_07 }}>Total Earnings</span>
								<span className="text-xl font-semibold text-[#7D7D7D]">21440</span>
								{/* Progress bar */}
							</div>
						</div>
					...
					<div className="bg-white shadow-[4px_4px_24px_0px_#0000001A] rounded-xl p-4 px-5 grid gap-5">
						<div className="flex items-center gap-6">
							...
							{/* Text Info */}
							<div className="flex flex-col gap-2 ">
								<span className="text-[#716F6F]" style={{ ...FONTS.heading_07 }}>Projects</span>
								<span className="text-xl font-semibold text-[#7D7D7D]">1000</span>
								{/* Progress bar */}
							</div>
						</div>
					...
					<div className="bg-white shadow-[4px_4px_24px_0px_#0000001A] rounded-xl p-4 px-5 grid gap-5">
						<div className="flex items-center gap-6">
							...
							{/* Text Info */}
							<div className="flex flex-col gap-2 ">
								<span className="text-[#716F6F]" style={{ ...FONTS.heading_07 }}>Instructor</span>
								<span className="text-xl font-semibold text-[#7D7D7D]">256</span>
								{/* Progress bar */}
							</div>
						</div>
					...
					<div className="bg-white shadow-[4px_4px_24px_0px_#0000001A] rounded-xl p-4 px-5 grid gap-5">
						<div className="flex items-center gap-6">
							...
							{/* Text Info */}
							<div className="flex flex-col gap-2 ">
								<span className="text-[#716F6F]" style={{ ...FONTS.heading_07 }}>students</span>
								<span className="text-xl font-semibold text-[#7D7D7D]">876</span>
								{/* Progress bar */}
							</div>
						</div>
					...
					<div className="bg-white shadow-[4px_4px_24px_0px_#0000001A] rounded-xl p-4 px-5 grid gap-5">
						<div className="flex items-center gap-6">
							...
							{/* Text Info */}
							<div className="flex flex-col gap-2 ">
								<span className="text-[#716F6F]" style={{ ...FONTS.heading_07 }}>Course</span>
								<span className="text-xl font-semibold text-[#7D7D7D]">365</span>
								{/* Progress bar */}
							</div>
						</div>
				...
				<section className="w-[75%]">
					...
					<div className=" bg-white rounded-xl mt-6 shadow-[4px_4px_24px_0px_#0000001A] p-4">
						...
						<div className="flex  justify-between items-center w-full">
							...
							<h1 style={{ ...FONTS.bold_heading, color: COLORS.gray_dark }}>Popular Course</h1>
						...
						<div className="mt-4 flex gap-4 w-full overflow-x-scroll scrollbar-hide py-3">
							...
							<section className=" min-w-[320px]  rounded-xl p-5 shadow-[4px_4px_24px_0px_#0000001A] flex items-start space-x-2  bg-[linear-gradient(101.51deg,_#1BBFCA_0%,_#0AA2AC_100%)]" >
								<img src={Students} className="w-15 h-15 bg-white rounded-full" alt="" />
								<div className="flex-grow">
									<h2 className=" text-white mb-1" style={{ ...FONTS.bold_heading }}>MEAN STACK 2024</h2>
									<p className="text-white text-sm mb-4 leading-tight" style={{ ...FONTS.description }}>
										The MERN Stack Is A Collection Of Technologies For Building
									</p>
									<p className="bg-white w-fit rounded-lg text-[#6C6C6C] px-4.5 py-2.5" style={{ ...FONTS.heading_08 }}>
										1 Modules
									</p>
								</div>
							</section>
							...
							<section className=" min-w-[320px] rounded-xl bg-white p-5 shadow-[4px_4px_24px_0px_#0000001A] flex items-start space-x-2">
								<img src={Students} className="w-15 h-15 bg-white rounded-full" alt="" />
								<div className="flex-grow">
									<h2 className=" text-[#716F6F] mb-1" style={{ ...FONTS.bold_heading }}>MEAN STACK 2024</h2>
									<p className="text-[#716F6F] text-sm mb-4 leading-tight" style={{ ...FONTS.description }}>
										The MERN Stack Is A Collection Of Technologies For Building
									</p>
									<p className="bg-white w-fit border-2 rounded-lg border-[#1A846C] text-[#1A846C] px-4 py-2" style={{ ...FONTS.heading_08 }}>
										1 Modules
									</p>
								</div>
							</section>
			...
			<div className="my-8 p-4 bg-white rounded-xl shadow-[4px_4px_24px_0px_#0000001A]">
				<h1 style={{ ...FONTS.bold_heading, color: COLORS.gray_dark }}>Recent Activities</h1>
				...
				<div className=" py-4 px-2 flex gap-4 w-full overflow-x-scroll scrollbar-hide">
					...
					<section className=" min-w-[300px]  rounded-xl p-5 shadow-[4px_4px_24px_0px_#0000001A] flex items-start space-x-4  bg-[linear-gradient(101.51deg,_#1BBFCA_0%,_#0AA2AC_100%)]" >
						<img src={Instructor} className="w-12 h-12 bg-white rounded-full" alt="" />
						<div className="flex-grow">
							<h2 className=" text-white mb-1" style={{ ...FONTS.notes_head }}>Notes Created</h2>
							<p className="text-white leading-tight" style={{ ...FONTS.description }}>| create | rvr - study material created</p>
						</div>
					</section>
					...
					<section className=" min-w-[300px] rounded-xl bg-white p-5 shadow-[4px_4px_24px_0px_#0000001A] flex items-start space-x-4">
						<img src={Instructor} className="w-12 h-12 bg-white rounded-full" alt="" />
						<div className="flex-grow">
							<h2 className=" mb-1" style={{ ...FONTS.notes_head }}>Notes Created</h2>
							<p className=" leading-tight" style={{ ...FONTS.description }}>| create | rvr - study material created</p>
						</div>
					</section>
