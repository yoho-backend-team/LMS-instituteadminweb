...
const StudentsAttendance = () => {
  ...
  return (
    <div className="w-full">
      {/* Header */}
      <div
        className="flex justify-between w-full h-[80px] pr-[16px] pl-[16px] items-center rounded-[8px]"
      ...
      >
        ...
        {!filterShow ? (
          <button
            ...
            className="w-[88px] h-[48px] flex items-center justify-center gap-1.5 rounded-[8px]"
          ...
          <button
            ...
            className="w-[67px] h-[48px] flex items-center justify-center rounded-[8px]"
            style={{ backgroundColor: "#FFFFFF", color: "#3ABE65" }}
          >
              ...
              >
                ...
                <div className="flex justify-between w-full items-center pl-2 pr-7">
                  {card?.students.map((img: any, idx: number) => (
                    <img
                      key={idx}
                      className="w-[62px] h-[62px] rounded-full bg-[#000000] border-2 border-white -ml-50 first:ml-0 z-[index]"
