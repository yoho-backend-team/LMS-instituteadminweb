...
const OtpVerification = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:grid lg:grid-cols-2">
      ...
      {/* FORM SECTION */}
      <div className="flex flex-col justify-between items-center w-full px-4 sm:px-6 lg:px-8 xl:px-14 py-8 sm:py-10 lg:py-0 order-2 lg:order-1">
        <section className="w-full ">
          ...
          {/* OTP Inputs */}
          <div className="w-full mt-6 sm:mt-8 lg:mt-10 flex justify-center gap-3 sm:gap-4 lg:gap-5">
