...
const Students = () => {
  ...
  const handleAddNewStudent = async () => {
    if (!newStudentForm.first_name || !newStudentForm.last_name || !newStudentForm.email) {
    ...
    try {
      ...
      let imageUrl = typeof newStudentForm.image === 'string' ? newStudentForm.image : null;
            ...
            >
              ...
              {newStudentForm.image ? (
                ...
                <>
                  ...
                  {isUploading && <p className="text-[14px] text-gray-500 mt-2">Uploading...</p>}
                </>
              )}
            </div>
          </CardContent>
