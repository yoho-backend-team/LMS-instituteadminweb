    ...
    return (
        <div>
            <div className={`flex justify-between w-full h-[80px] bg-[${COLORS.primary}] pr-[16px] rounded-[8px] pl-[16px] items-center `}>
                ...
                <button className="pt-[8px] pb-[8px] pr-[16px] pl-[16px] text-[#3ABE65] w-[67px] h-[48px] rounded-[8px]">Show</button>
            </div>

            {/* Filter */}
            <div className="mt-5 shadow-[0px_4px_20px_rgba(0,0,0,0.25)] rounded-[12px]">
                <h3 className={`pl-4 pt-4 pr-4 pb-7  !font-semibold text-[${COLORS.gray_dark}]`} style={{ ...FONTS.heading_05 }}>Filters</h3>
                <label htmlFor="dropdown" className={`pl-4 text-[${COLORS.gray_dark}]`}>Batches</label>
