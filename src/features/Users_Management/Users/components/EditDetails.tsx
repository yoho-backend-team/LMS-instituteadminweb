    ...
    return (
        <div className="w-full sm:w-[95%] md:w-[700px] lg:w-[750px] xl:w-[782px] bg-white rounded-lg border p-4 sm:p-5 md:p-6 max-h-screen overflow-y-auto">
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className={`border bg-[${COLORS.primary}] h-[44px] sm:h-[46px] md:h-[48px] rounded-xl text-white flex items-center justify-center px-3`}>
                    <h1 className="text-base sm:text-lg md:text-xl" style={{ ...FONTS.heading_05_bold }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-4 md:gap-5">
                    <div className="grid gap-1 sm:gap-1.5">
                        <label className={`text-[${COLORS.gray_dark_02}] text-sm sm:text-base`} style={{ ...FONTS.heading_08_bold }}>
                            First Name
                        </label>
                        <Input
                            {...register("first_name")}
